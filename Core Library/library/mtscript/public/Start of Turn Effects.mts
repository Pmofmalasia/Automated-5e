...
[h:validAbilities = json.path.read(allAbilities,"[*][?(@.Duration.AdvancePoint=='StartofTurn')]")]
...
[h:validConditions = json.path.read(ConditionGroups,"[*][?(@.Duration.AdvancePoint=='StartofTurn')]")]
...
[h:targetsAffected = ""]
[h:validConditionsSet = json.path.read(ConditionsSet,"[*][?(@.Duration.AdvancePoint=='StartofSetByTurn')]")]
