...
[h:spellCreationHTML = spellCreationHTML + "<tr id='rowDurationAHL'><th><label for='AHLDuration'>Duration Increases at Higher Levels:</label></th><td style='text-align:center'><input type='checkbox' id='AHLDuration' name='AHLDuration' onchange='ahlDuration()' value=1></td></tr>"]
[h:spellCreationHTML = spellCreationHTML + "<tr><th><label for='isConcentration'>Concentration:</label></th><td style='text-align:center'><input type='checkbox' id='isConcentration' name='isConcentration' value=1></td></tr>"]
[h:spellCreationHTML = spellCreationHTML + "<tr id='rowConcLost'><th><label for='ConcentrationLost'>Concentration Not Required at Higher Levels:</label></th><td style='text-align:center'><input type='checkbox' id='ConcentrationLost' name='ConcentrationLost' onchange='concLost()' value=1></td></tr>"]
