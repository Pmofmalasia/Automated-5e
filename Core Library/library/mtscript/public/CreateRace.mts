[h:RaceInputHTML = "<tr id='rowHeader'><th text-align='center' colspan='2'>Create Race</th></tr>"]

[h:RaceInputHTML = RaceInputHTML + "<tr id='rowDisplayName'><th><label for='DisplayName'>Race Name:</label></th><td><input type='text' id='DisplayName' name='DisplayName' autofocus></td></tr>"]
...
[h:RaceInputHTML = RaceInputHTML + "<tr id='rowRaceCountsAs'><th><label for='RaceCountsAs'>Counts as Other Race:</label></th><td><select id='RaceCountsAs' name='RaceCountsAs'><option value=''>None</option>"+OtherRaceOptions+"</select></td></tr>"]
...
[h:RaceInputHTML = RaceInputHTML + "<tr id='rowAttributeAllocationMethod'><th><label for='AttributeAllocationMethod'>How are Attributes Allocated:</label></th><td><select id='AttributeAllocationMethod' name='AttributeAllocationMethod' onchange='createAttributeSelectionRows("+'"CreateRaceTable","rowSpeed"'+")'><option value='Choice'>Any +2/+1 or +1/+1/+1</option><option value='Preset'>Preset</option><option value='Mixed'>Mixed Preset + Choice</option><option value=''>None Granted</option></select></td></tr>"]
...
[h:RaceInputHTML = RaceInputHTML + "<tr id='rowLanguageKnownButtons'><th text-align='center' colspan='2'><input type='button' id='addLanguageKnown' value='New Language Known' onclick='addLanguageKnownRow("+'"CreateRaceTable"'+")'>  <input type='button' id='removeLanguageKnown' value='Remove Language Known' onclick='removeLanguageKnownRow("+'"CreateRaceTable"'+")'><input type='hidden' id='LanguageKnownNumber' name='LanguageKnownNumber' value=0></th></tr>"]
