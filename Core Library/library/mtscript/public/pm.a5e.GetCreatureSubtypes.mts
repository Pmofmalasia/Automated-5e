...
[h,if(pm.KeyChoice==""),CODE:{
	[h:pm.CreatureSubtypes = json.path.read(getLibProperty("sb.CreatureSubtypes","Lib:pm.a5e.Core"),"[?(@.CreatureType=='"+pm.CreatureType+"')]")]
};{
	[h:pm.CreatureSubtypes = json.path.read(getLibProperty("sb.CreatureSubtypes","Lib:pm.a5e.Core"),"[?(@.CreatureType=='"+pm.CreatureType+"')]['"+pm.KeyChoice+"']")]
}]
