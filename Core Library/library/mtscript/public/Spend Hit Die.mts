...
[h,switch(HDPick),code:
	case 0:{[HitDie=12][HDSelect=Twelve][roll=1d12][heal=if(Twelve>0,roll+json.get(getProperty("a5e.stat.AtrMods"), "Constitution")+HealBonus,0)][HitDice=json.set(HitDice,"1d12",max(Twelve-1,0))]};
	case 1:{[HitDie=10][HDSelect=Ten][roll=1d10][heal=if(Ten>0,roll+json.get(getProperty("a5e.stat.AtrMods"), "Constitution")+HealBonus,0)][HitDice=json.set(HitDice,"1d10",max(Ten-1,0))]};
	case 2:{[HitDie=8][HDSelect=Eight][roll=1d8][heal=if(Eight>0,roll+json.get(getProperty("a5e.stat.AtrMods"), "Constitution")+HealBonus,0)][HitDice=json.set(HitDice,"1d8",max(Eight-1,0))]};
	case 3:{[HitDie=6][HDSelect=Six][roll=1d6][heal=if(Six>0,roll+json.get(getProperty("a5e.stat.AtrMods"), "Constitution")+HealBonus,0)][HitDice=json.set(HitDice,"1d6",max(Six-1,0))]}
]
