...
[h:SaveInputHTML = SaveInputHTML + "<tr id='rowSubmit'><th style='text-align:center' colspan='2'><input type='submit' class='theme-fix-submit' id='submitButton' value='Make Save'></tr>"]
