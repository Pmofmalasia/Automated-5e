...
[h,switch(RollType),CODE:
    case "Check":{
        [h,if(json.get(RollData,"ID")!=""),CODE:{
            ...
            [h:RollData = json.get(json.path.read(getLibProperty("gd.Effects","Lib:pm.a5e.Core"),"[*][?(@.ID=="+effectID+")]['ToResolve']['CheckDC']['ChecksMade']['"+EffectTarget+"']"),0)]
        };{
            [h:effectID = ""]
        }]
    };
...
[h,switch(RollType),CODE:
    case "Check":{
        ...
        [h,if(effectID==""),CODE:{};{
            ...
            [h:rerolledEffect = json.path.set(getLibProperty("gd.Effects","Lib:pm.a5e.Core"),"[*][?(@.ID=="+effectID+")]['ToResolve']['CheckDC']['ChecksMade']['"+EffectTarget+"']",json.remove(ReturnData,"EffectID"))]
