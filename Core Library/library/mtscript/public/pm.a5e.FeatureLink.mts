...
[h:currentFeatureLink = macroLinkText(if(currentFeatureAltName=="",currentFeatureName,js.a5e.RemoveSpecial(currentFeatureAltName))+" ### "+currentFeatureClass+" ### "+if(currentFeatureSubclass=="","",currentFeatureSubclass+" ### ")+if(currentFeatureType=="Feature","",currentFeatureType+" ### ")+"Link@Lib:"+currentFeatureLibrary,"gm-self",json.set(currentFeatureExtraData,"ParentToken",ParentToken,"IsTooltip",0,"Context",currentFeatureContext,"OverarchingContext",pm.a5e.OverarchingContext,"CallingFeature",json.set("","Name",currentFeatureName,"Class",currentFeatureClass,"Subclass",currentFeatureSubclass)),ParentToken)]
[h:currentFeatureTooltipLink = macroLinkText(if(currentFeatureAltName=="",currentFeatureName,js.a5e.RemoveSpecial(currentFeatureAltName))+" ### "+currentFeatureClass+" ### "+if(currentFeatureSubclass=="","",currentFeatureSubclass+" ### ")+if(currentFeatureType=="Feature","",currentFeatureType+" ### ")+"Link@Lib:"+currentFeatureLibrary,"gm-self",json.set(currentFeatureExtraData,"ParentToken",ParentToken,"IsTooltip",1,"Context",currentFeatureContext,"OverarchingContext",pm.a5e.OverarchingContext,"CallingFeature",json.set("","Name",currentFeatureName,"Class",currentFeatureClass,"Subclass",currentFeatureSubclass)),ParentToken)]
[h,if(IsTooltip),CODE:{
