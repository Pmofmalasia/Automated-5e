...
[h:targetCreatureTagInclusive = json.get(creatureFilteringData,"CreatureTagInclusive")]
...
[h:targetCreatureTagExclusive = json.get(creatureFilteringData,"CreatureTagExclusive")]
...
[h:inclusiveCreatureTagDisplay = pm.a5e.TypeFilteringDisplay(targetCreatureTagInclusive,1)]
[h:exclusiveTypeDisplay = pm.a5e.TypeFilteringDisplay(targetTypeExclusive,0)]
[h:exclusiveCreatureTagDisplay = pm.a5e.TypeFilteringDisplay(targetCreatureTagExclusive,0)]

[h:finalDisplay = allegianceDisplay]
[h,if(inclusiveTypeDisplay != ""): finalDisplay = listAppend(finalDisplay,inclusiveTypeDisplay,", ")]
[h,if(inclusiveCreatureTagDisplay != ""): finalDisplay = listAppend(finalDisplay,inclusiveCreatureTagDisplay,", ")]
[h,if(exclusiveTypeDisplay != ""): finalDisplay = listAppend(finalDisplay,exclusiveTypeDisplay,", ")]
[h,if(exclusiveCreatureTagDisplay != ""): finalDisplay = listAppend(finalDisplay,exclusiveCreatureTagDisplay,", ")]
