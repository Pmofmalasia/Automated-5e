...
[h,if(AllSourcesTest),CODE:{
	...
	[h,if(json.get(modifierInstance,"IncludeCreatureType")==""): CreatureTypeTest = 1; CreatureTypeTest = if(json.get(hp.Data,"")=="SourceToken",0,json.contains(json.get(modifierInstance,"IncludeCreatureType"),getProperty("CreatureType",json.get(hp.Data,"SourceToken"))))]
	[h,if(json.get(modifierInstance,"ExcludeCreatureType")==""): ExcludeCreatureTypeTest = 1; ExcludeCreatureTypeTest = if(json.get(hp.Data,"SourceToken")=="",1,!json.contains(json.get(modifierInstance,"ExcludeCreatureType"),getProperty("CreatureType",json.get(modifierInstance,"SourceToken"))))]
	[h,if(json.get(modifierInstance,"HasCondition")==""): HasConditionTest = 1; HasConditionTest = if(json.get(hp.Data,"SourceToken")=="",0,!json.isEmpty(json.intersection(json.get(modifierInstance,"HasCondition"),json.path.read(getProperty("ConditionList",json.get(modifierInstance,"SourceToken")),"[*]['Name']"))))]
	[h,if(json.get(modifierInstance,"IncludeMorality")==""): IncludeMoralityTest = 1; IncludeMoralityTest = if(json.get(hp.Data,"SourceToken")=="",0,json.contains(json.get(modifierInstance,"IncludeMorality"),json.get(getProperty("Alignment",json.get(modifierInstance,"SourceToken")),"Morality")))]
	[h,if(json.get(modifierInstance,"ExcludeMorality")==""): ExcludeMoralityTest = 1; ExcludeMoralityTest = if(json.get(hp.Data,"SourceToken")=="",1,!json.contains(json.get(modifierInstance,"ExcludeMorality"),json.get(getProperty("Alignment",json.get(modifierInstance,"SourceToken")),"Morality")))]
	[h,if(json.get(modifierInstance,"IncludeOrder")==""): IncludeOrderTest = 1; IncludeOrderTest = if(json.get(hp.Data,"SourceToken")=="",0,json.contains(json.get(modifierInstance,"IncludeOrder"),json.get(getProperty("Alignment",json.get(modifierInstance,"SourceToken")),"Order")))]
	[h,if(json.get(modifierInstance,"ExcludeOrder")==""): ExcludeOrderTest = 1; ExcludeOrderTest = if(json.get(hp.Data,"SourceToken")=="",1,!json.contains(json.get(modifierInstance,"ExcludeOrder"),json.get(getProperty("Alignment",json.get(modifierInstance,"SourceToken")),"Order")))]
