...
[h,if(effectID==""),CODE:{};{
	...
	[h,if(json.get(CheckData,"Contested")==1): 
		rerolledEffect = json.path.setcarefully(getLibProperty("gd.Effects","Lib:pm.a5e.Core"),"[*][?(@.ID=="+effectID+")]['ToResolve']['CheckDC']['DC']",json.remove(CheckData,"EffectID"));
		rerolledEffect = json.path.setcarefully(getLibProperty("gd.Effects","Lib:pm.a5e.Core"),"[*][?(@.ID=="+effectID+")]['ToResolve']['CheckDC']['ChecksMade']['"+ParentToken+"']",json.remove(CheckData,"EffectID"))
	]
