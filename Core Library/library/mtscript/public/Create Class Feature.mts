...
[h,if(ab.Replace),CODE:{
	[h,if(ab.ReplaceCreated>0),CODE:{
		...
		[h:ab.ReplacedFeature = json.set("","Name",js.a5e.RemoveSpecial(ab.ReplaceName),"DisplayName",ab.ReplaceName,"Class",ab.ReplaceClass,"Subclass",if(ab.ReplaceSubclass=="None","",js.a5e.RemoveSpecial(ab.ReplaceSubclass)))]
	};{
		[h:abort(input(
