...
[h,if(ab.WeaponAttacks),CODE:{
	[h:abort(input(
		...
		" junkVar | ------------------------------------------------------------ | 0 | LABEL | SPAN=TRUE ",
		" ab.WeaponAttackDamage | 0 | <html><span title='Use for effects that grant a damage type based on the weapon used. For effects that grant damage independent of the weapons damage type, use effect after attack or after each attack (whichever is appropriate)'>Grants Bonus to Weapon Damage</span></html> | CHECK ",
