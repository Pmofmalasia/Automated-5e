...
[h:mCompItems=json.get(SpellData,"mComponents")]
[h:mCompConsumed=json.get(SpellData,"mComponenetsConsumed")]
...
[h:IsSight=json.contains(SpellData,"IsSight")]
[h:sConcentration=json.contains(SpellData,"isConcentration")]
...
[h:BarbarianToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Constitution"))]
[h:BardToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:ClericToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:DruidToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:FighterToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]
[h:MonkToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:PaladinToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:RangerToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:RogueToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]
[h:SorcererToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:WarlockToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:WizardToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]
[h:ArtificerToHit=(getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]

[h:BarbarianDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Constitution"))]
[h:BardDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:ClericDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:DruidDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:FighterDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]
[h:MonkDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:PaladinDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:RangerDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Wisdom"))]
[h:RogueDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]
[h:SorcererDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:WarlockDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Charisma"))]
[h:WizardDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]
[h:ArtificerDC=(8+getProperty("a5e.stat.Proficiency")+json.get(getProperty("a5e.stat.AtrMods"), "Intelligence"))]
