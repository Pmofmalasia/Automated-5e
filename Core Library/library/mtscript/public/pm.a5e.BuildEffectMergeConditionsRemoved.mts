...
")==""),CODE:{
    ...
    [h,if(json.get(newEffect,"Groups")!=""): oldEffectConditionsRemoved = json.set(oldEffectConditionsRemoved,"Groups",json.merge(json.get(oldEffectConditionsRemoved,"Groups
    "),json.get(newEffect,"Groups")))]
}]
...
[h,if(json.get(oldEffectConditionsRemoved,"ConditionTypes")==""),CODE:{
    ...
    [h,if(json.get(newEffect,"ConditionTypes")!=""): oldEffectConditionsRemoved = json.set(oldEffectConditionsRemoved,"ConditionTypes",json.merge(json.get(oldEffectConditionsRemoved,"ConditionTypes
    "),json.get(newEffect,"ConditionTypes")))]
}]
...
[h,if(json.get(oldEffectConditionsRemoved,"ConditionNames")==""),CODE:{
    ...
    [h,if(json.get(newEffect,"ConditionNames")!=""): oldEffectConditionsRemoved = json.set(oldEffectConditionsRemoved,"ConditionNames",json.merge(json.get(oldEffectConditionsRemoved,"ConditionNames
    "),json.get(newEffect,"ConditionNames")))]
}]
