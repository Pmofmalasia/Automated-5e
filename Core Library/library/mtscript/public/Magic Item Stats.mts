...
[h,count(json.length(MagicItemNames)),CODE:{
    ...
    [h:tStrSetOverride=if(GivesBonusTest,if(tStrSetOverride==-1,min(json.get(json.get(MagicItemAttributes,roll.count),"StrSetOverride"),max(pStrength+tStrBonus,tStrSet)),min(json.get(json.get(MagicItemAttributes,roll.count),"StrSetOverride"),tStrSetOverride)),tStrSetOverride)]
    [h:tDexSetOverride=if(GivesBonusTest,if(tDexSetOverride==-1,min(json.get(json.get(MagicItemAttributes,roll.count),"DexSetOverride"),max(pDexterity+tDexBonus,tDexSet)),min(json.get(json.get(MagicItemAttributes,roll.count),"DexSetOverride"),tDexSetOverride)),tDexSetOverride)]
    [h:tConSetOverride=if(GivesBonusTest,if(tConSetOverride==-1,min(json.get(json.get(MagicItemAttributes,roll.count),"ConSetOverride"),max(pConstitution+tConBonus,tConSet)),min(json.get(json.get(MagicItemAttributes,roll.count),"ConSetOverride"),tConSetOverride)),tConSetOverride)]
    [h:tIntSetOverride=if(GivesBonusTest,if(tIntSetOverride==-1,min(json.get(json.get(MagicItemAttributes,roll.count),"IntSetOverride"),max(pIntelligence+tIntBonus,tIntSet)),min(json.get(json.get(MagicItemAttributes,roll.count),"IntSetOverride"),tIntSetOverride)),tIntSetOverride)]
    [h:tWisSetOverride=if(GivesBonusTest,if(tWisSetOverride==-1,min(json.get(json.get(MagicItemAttributes,roll.count),"WisSetOverride"),max(pWisdom+tWisBonus,tWisSet)),min(json.get(json.get(MagicItemAttributes,roll.count),"WisSetOverride"),tWisSetOverride)),tWisSetOverride)]
    [h:tChaSetOverride=if(GivesBonusTest,if(tChaSetOverride==-1,min(json.get(json.get(MagicItemAttributes,roll.count),"ChaSetOverride"),max(pCharisma+tChaBonus,tChaSet)),min(json.get(json.get(MagicItemAttributes,roll.count),"ChaSetOverride"),tChaSetOverride)),tChaSetOverride)]
}]
}]
