...
[h,if(newEntryTest),CODE:{
	...
	[h,count(NumberOfEntries),CODE:{
		...
		[h,if(NeedsEffectFeatureResourceTest): TempChosenItem = json.path.putcarefully(TempChosenItem,"['Effects'][*]['Subeffects'][*]['UseResource']['Feature']['Resource'][?(@.Name == '"+json.get(TempChosenItem,"Name")+"' && @.Class == 'Item')]","ItemID",NewItemID)]
		[h,if(NeedsWeaponEffectFeatureResourceTest): TempChosenItem = json.path.putcarefully(TempChosenItem,"['WeaponEffects'][*]['Subeffects'][*]['UseResource']['Feature']['Resource'][?(@.Name == '"+json.get(TempChosenItem,"Name")+"' && @.Class == 'Item')]","ItemID",NewItemID)]
		[h,if(NeedsSpellFeatureResourceTest): TempChosenItem = json.path.putcarefully(TempChosenItem,"['ItemSpellcasting'][*]['UseResource']['Feature']['Resource'][?(@.Name == '"+json.get(TempChosenItem,"Name")+"' && @.Class == 'Item')]","ItemID",NewItemID)]
	...
	[h,if(NeedsEffectFeatureResourceTest): ChosenItem = json.path.putcarefully(ChosenItem,"['Effects'][*]['Subeffects'][*]['UseResource']['Feature']['Resource'][?(@.Name == '"+json.get(ChosenItem,"Name")+"' && @.Class == 'Item')]","ItemID",OldEntryID)]
	[h,if(NeedsWeaponEffectFeatureResourceTest): ChosenItem = json.path.putcarefully(ChosenItem,"['WeaponEffects'][*]['Subeffects'][*]['UseResource']['Feature']['Resource'][?(@.Name == '"+json.get(ChosenItem,"Name")+"' && @.Class == 'Item')]","ItemID",OldEntryID)]
	[h,if(NeedsSpellFeatureResourceTest): ChosenItem = json.path.putcarefully(ChosenItem,"['ItemSpellcasting'][*]['UseResource']['Feature']['Resource'][?(@.Name == '"+json.get(ChosenItem,"Name")+"' && @.Class == 'Item')]","ItemID",NewItemID)]

	[h:NewNumber = json.get(OldEntryData,"Number") + json.get(AddItemData,"NumberAdded")]
	[h:NewInventory = json.path.setcarefully(PriorInventory,"[*][?(@.ObjectID == '"+ItemChoiceID+"')]['Number']",NewNumber)]
