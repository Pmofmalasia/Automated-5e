...
[h:pm.CurrentAbilitiesTemp = json.path.read(allAbilities,"[?(@.Master=='"+pm.Ability+"' && @.Class=='"+pm.Class+"' && (@.Subclass=='"+pm.Subclass+"' || @.Subclass=='') && @.IsActive > 0)]")]
...
[h,foreach(ability,pm.CurrentAbilitiesTemp),CODE:{
	[h:pm.CurrentAbilities = json.merge(pm.CurrentAbilities,json.path.read(getLibProperty("sb.Abilities","Lib:pm.a5e.Core"),"[?(@.Name=='"+json.get(ability,"Name")+"' && @.Class=='"+json.get(ability,"Class")+"' && (@.Subclass=='"+json.get(ability,"Subclass")+"' || @.Subclass==''))]"))]
}]
...
[h,if(pm.FromCharacter == 1),CODE:{
	[h:pm.AbilitiesList = json.path.read(allAbilities,"[?(@.Master=='"+pm.Ability+"' && @.Class=='"+pm.Class+"' && (@.Subclass=='"+pm.Subclass+"' || @.Subclass==''))]")]
};{
	[h:pm.AbilitiesList = json.path.read(getLibProperty("sb.Abilities","Lib:pm.a5e.Core"),"[?(@.Master=='"+pm.Ability+"' && @.Class=='"+pm.Class+"' && (@.Subclass=='"+pm.Subclass+"' || @.Subclass=='') && @.Level<="+pm.LevelPrereq+")]")]
}]

[h:pm.AbilitiesList = json.sort(pm.AbilitiesList,"a","Name")]

[h,if(pm.Tooltip),CODE:{
	[h:pm.AbilitiesChosenStr = json.toList(json.path.read(allAbilities,"[?(@.Master=='"+pm.Ability+"' && @.Class=='"+pm.Class+"' && (@.Subclass=='"+pm.Subclass+"' || @.Subclass=='') && @.IsActive > 0)]['DisplayName']"),if(json.get(getLibProperty("TooltipVertical","Lib:pm.a5e.Core"),getPlayerName())=="",if(json.get(getLibProperty("TooltipVertical","Lib:pm.a5e.Core"),"Default")==1,"<br>",", "),if(json.get(getLibProperty("TooltipVertical","Lib:pm.a5e.Core"),getPlayerName())==1,"<br>",", ")))]
};{
	[h:pm.AbilitiesChosenStr = json.toList(json.path.read(allAbilities,"[?(@.Master=='"+pm.Ability+"' && @.Class=='"+pm.Class+"' && (@.Subclass=='"+pm.Subclass+"' || @.Subclass=='') && @.IsActive > 0)]['DisplayName']"),if(getLibProperty("VerticalDisplay","Lib:pm.a5e.Core"),"<br>",", "))]
	...
	[h,foreach(ability,pm.AbilitiesList),CODE:{
		[h:set("pm.Choose"+json.get(ability,"Name"),if(json.isEmpty(json.path.read(allAbilities,"[?(@.Name=='"+json.get(ability,"Name")+"' && @.Master=='"+pm.Ability+"' && @.Class=='"+pm.Class+"' && (@.Subclass=='"+pm.Subclass+"' || @.Subclass=='') && @.IsActive > 0)]")),0,1))]
