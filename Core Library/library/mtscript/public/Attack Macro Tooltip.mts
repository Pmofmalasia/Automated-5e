...
[h:PrimeStat=if(listFind(json.get(json.get(Weapon,json.get(Weapon,WhichHand)),"Props"),"Finesse")>-1,max(json.get(getProperty("a5e.stat.AtrMods"),"Dexterity"),json.get(getProperty("a5e.stat.AtrMods"),"Strength")),json.get(getProperty("a5e.stat.AtrMods"),"Strength"))]
[h:PrimeStat=if(listFind(json.get(json.get(Weapon,json.get(Weapon,WhichHand)),"Props"),"Ammunition")>-1,json.get(getProperty("a5e.stat.AtrMods"),"Dexterity"),PrimeStat)]
[h:PrimeStat=if(listFind(json.get(json.get(Weapon,json.get(Weapon,WhichHand)),"Props"),"WisMod")>-1,json.get(getProperty("a5e.stat.AtrMods"),"Wisdom"),PrimeStat)]
[h:PrimeStat=if(listFind(json.get(json.get(Weapon,json.get(Weapon,WhichHand)),"Props"),"ChaMod")>-1,json.get(getProperty("a5e.stat.AtrMods"),"Charisma"),PrimeStat)]
