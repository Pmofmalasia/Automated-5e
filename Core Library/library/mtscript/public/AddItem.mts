...
<tr><th style='text-align:center' colspan='2'><input type='submit' class='theme-fix-submit' id='submitButton' value='Give to "+getName(ParentToken)+"'></th></tr><input type='hidden' name='ParentToken' id='ParentToken' value='"+ParentToken+"'>"]
