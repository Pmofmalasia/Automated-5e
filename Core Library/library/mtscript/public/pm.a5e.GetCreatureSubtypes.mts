...
[h,if(pm.KeyChoice==""),CODE:{
	[h:pm.CreatureSubtypes = json.path.read(data.getData("addon:","pm.a5e.core","sb.CreatureSubtypes"),"\$[*][?(@.CreatureType=='"+pm.CreatureType+"' || @.CreatureType=='')]")]
};{
	[h:pm.CreatureSubtypes = json.path.read(data.getData("addon:","pm.a5e.core","sb.CreatureSubtypes"),"\$[*][?(@.CreatureType=='"+pm.CreatureType+"' || @.CreatureType=='')]['"+pm.KeyChoice+"']")]
}]
