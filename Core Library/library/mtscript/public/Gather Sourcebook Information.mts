...
[h,foreach(book,pm.SourcebookLibs),CODE:{
	...
	[h,if(getLibProperty("sb.CreatureTags","Lib:"+book)!=""): pm.CreatureTags = json.merge(pm.CreatureTags,getLibProperty("sb.CreatureTags","Lib:"+book))]
...
[h:data.setData("addon:","pm.a5e.core","sb.CreatureTags",json.sort(pm.CreatureTags,"a","DisplayName"))]
