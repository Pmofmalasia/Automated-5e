...
[h:spellCreationHTML = spellCreationHTML + "<tr><th><label for='mComp'>Material Components:</label></th><td style='text-align:center'><input type='checkbox' id='mComp' name='mComp' onchange='mCompInput()' value=1></td></tr>"]
