...
[h:broadcast("DMOnly isNum: "+(1000+DMOnly))]
[h:broadcast("HideEnemyMacros isNum: "+(1000+getLibProperty("HideEnemyMacros","Lib:pm.a5e.Core")))]
[h:broadcast("HideAllyMacros isNum: "+(1000+getLibProperty("HideAllyMacros","Lib:pm.a5e.Core")))]
[h:broadcast("PC.Ally.Enemy isNum: "+(1000+PC.Ally.Enemy))]
[h:broadcast("If there is no output below this is definitely the problem")]
[h:outputTest.NoRules = if(DMOnly,if(or(and(getLibProperty("HideEnemyMacros","Lib:pm.a5e.Core")<1,PC.Ally.Enemy==2),and(getLibProperty("HideAllyMacros","Lib:pm.a5e.Core")<1,PC.Ally.Enemy==1)),0,1),0)]
[h:broadcast("It wasn't the problem")]
[h:outputTest.NoRolls = if(DMOnly,if(or(and(getLibProperty("HideEnemyMacros","Lib:pm.a5e.Core")<2,PC.Ally.Enemy==2),and(getLibProperty("HideAllyMacros","Lib:pm.a5e.Core")<2,PC.Ally.Enemy==1)),0,1),0)]
[h:outputTest.NoFullMacro = if(DMOnly,if(or(and(getLibProperty("HideEnemyMacros","Lib:pm.a5e.Core")<3,PC.Ally.Enemy==2),and(getLibProperty("HideAllyMacros","Lib:pm.a5e.Core")<3,PC.Ally.Enemy==1)),if(and(OnlyRules,outputTest.NoRules),1,0),1),0)]
...
[h:output.GM = ""]
	...
	[h:output.Temp="<div style='background-color:"+if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkBackground'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightBackground'))+'; color: '+if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkText'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightText'))+'; padding:2px; width:100%; font-family:'+if(BodyFont=="",json.get(getLibProperty("ChatFonts","Lib:pm.a5e.Core"),"Body"),BodyFont)+"'>"]
	
	[h:output.PC = if(outputTest.NoFullMacro,output.PC,output.PC+output.Temp)]
	[h:output.GM = output.GM + output.Temp]
	
	[h:output.Temp=if(or(Flavor==(token.name+" FLAVOR TEXT"),Flavor==""),"",'<div style="text-align:center; background-color:'+if(AccentBackgroundOverride=="",if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentBackground"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentBackground")),AccentBackgroundOverride)+"; color:"+if(AccentTextOverride=="",if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentText"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentText")),AccentTextOverride)+';">'+"<i>"+Flavor+"</i></div>")]
	[h:output.PC = if(outputTest.NoFullMacro,output.PC,output.PC+output.Temp)]
	[h:output.GM = output.GM + output.Temp]

[h:BackgroundColor = if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkBackground'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightBackground'))]
[h:BackgroundText = if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkText'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightText'))]
...
[h:AccentText = if(AccentTextOverride=="",if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentText"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentText")),AccentTextOverride)]
[h:AccentColor = if(AccentBackgroundOverride=="",if(getLibProperty("DarkMode","Lib:pm.a5e.Core"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentBackground"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentBackground")),AccentBackgroundOverride)]
