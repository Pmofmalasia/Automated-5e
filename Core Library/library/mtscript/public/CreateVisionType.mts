[h:CreateVisionTypeHTML = "<tr id='rowHeader'><th style='text-align:center' colspan='2'>Create Vision Type</th></tr>"]
...
[h:CreateVisionTypeHTML = CreateVisionTypeHTML + "<tr id='rowSubmit'><th style='text-align:center' colspan='2'><input type='submit' class='theme-fix-submit' id='submitButton' value='Submit'></th></tr>"]
