...
[h,foreach(save,pm.GetAttributes("Name","json")),CODE:{
	[h:tempBaseSaveProf = json.get(getProperty("stat.BaseSaves"),save)]
	[h,if(tempBaseSaveProf!=0 && tempBaseSaveProf!=""): pm.SaveProfs = json.append(pm.SaveProfs,tempBaseSaveProf)]
