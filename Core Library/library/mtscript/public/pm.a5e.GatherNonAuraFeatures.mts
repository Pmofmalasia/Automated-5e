[h:switchToken(arg(0))]
[h:a5e.UnifiedAbilities = json.path.putcarefully(getProperty("a5e.stat.AllFeatures"),"[*]","AbilityType","Feature")]
[h:a5e.ConditionsToBeUnified = json.path.putcarefully(getProperty("a5e.stat.ConditionList"),"[*]","IsActive",1)]
[h:a5e.UnifiedAbilities = json.merge(a5e.UnifiedAbilities,json.path.putcarefully(a5e.ConditionsToBeUnified,"[*]","AbilityType","Condition"))]
...
[h:a5e.InventoryAbilities = json.path.putcarefully(a5e.InventoryAbilities,"[*]","AbilityType","Item")]
...
[h:a5e.ItemConditions = json.path.putcarefully(a5e.ItemConditions,"[*]","AbilityType","ItemCondition")]
