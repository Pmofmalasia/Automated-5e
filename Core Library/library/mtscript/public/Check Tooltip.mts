...
[h,foreach(TempSkill,pm.GetSkills()): abilityTable = json.append(abilityTable,json.set("",
	...
	"FalseHeader","",
	"FullContents","",
	"RulesContents",pm.PlusMinus(json.get(getProperty("a5e.stat.AtrMods"),json.get(TempSkill,"Attribute"))+(json.get(getProperty("a5e.stat.Skills"),json.get(TempSkill,"Name"))*getProperty("a5e.stat.Proficiency")),1),
	"RollContents","",
