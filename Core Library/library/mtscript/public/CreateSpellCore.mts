...
[h:spellCreationHTML = spellCreationHTML + "<tr><th><label for='multiSubeffects'><span title='Increase if a spell effect has different parts that have different conditions for resolving. For example, Ice Knife makes an attack against a single target (effect 1), then forces a save against all creatures around them (effect 2); Ray of Sickness makes a spell attack to deal damage (effect 1), then forces that target to make a save against poison if it hits (effect 2); and Vampiric Touch makes an attack to deal damage (effect 1), then heals the caster for half the amount of damage dealt (effect 2).'>Number of Subeffects:</span></label></th><td><input type='number' id='multiSubeffects' name='multiSubeffects' min='1' value='1'></td></tr><tr><th text-align='center' colspan='2'><input type='submit' id='submitButton' value='Submit'></th></tr><tr><th text-align='center' colspan='2'>Full Spell Description:</th></tr><tr><th>Paragraph 1:</th><td><input type='text' id='descPara1' name='descPara1'></td></tr><tr><th>Paragraph 2:</th><td><input type='text' id='descPara2' name='descPara2'></td></tr><tr><th>Paragraph 3:</th><td><input type='text' id='descPara3' name='descPara3'></td></tr><tr><th>Paragraph 4:</th><td><input type='text' id='descPara4' name='descPara4'></td></tr><tr><th>Paragraph 5:</th><td><input type='text' id='descPara5' name='descPara5'></td></tr><tr><th>Paragraph 6:</th><td><input type='text' id='descPara6' name='descPara6'></td></tr><tr><th>Paragraph 7:</th><td><input type='text' id='descPara7' name='descPara7'></td></tr>"]
