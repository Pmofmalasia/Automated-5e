...
[h:width.Setting=if(number(getLibProperty("useWidth","Lib:pm.a5e.Core"))==2,"",if(number(getLibProperty("useWidth","Lib:pm.a5e.Core"))==1,"max-width:"+string(getLibProperty("DisplaySize","Lib:pm.a5e.Core"))+"px;",'width:'+string(getLibProperty("DisplaySize","Lib:pm.a5e.Core"))+'px;'))]
...
[h:output.GM = ""]
	...
	[h:output.Temp="<div style='background-color:"+if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkBackground'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightBackground'))+'; color: '+if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkText'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightText'))+'; padding:2px; width:100%; font-family:'+if(BodyFont=="",json.get(getLibProperty("ChatFonts","Lib:pm.a5e.Core"),"Body"),BodyFont)+"'>"]
	
	[h:output.PC = if(outputTest.NoFullMacro,output.PC,output.PC+output.Temp)]
	[h:output.GM = output.GM + output.Temp]
	
	[h:output.Temp=if(or(Flavor==(token.name+" FLAVOR TEXT"),Flavor==""),"",'<div style="text-align:center; background-color:'+if(AccentBackgroundOverride=="",if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentBackground"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentBackground")),AccentBackgroundOverride)+"; color:"+if(AccentTextOverride=="",if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentText"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentText")),AccentTextOverride)+';">'+"<i>"+Flavor+"</i></div>")]
	[h:output.PC = if(outputTest.NoFullMacro,output.PC,output.PC+output.Temp)]
	[h:output.GM = output.GM + output.Temp]

[h:BackgroundColor = if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkBackground'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightBackground'))]
[h:BackgroundText = if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'DarkText'),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),'LightText'))]
...
[h:AccentText = if(AccentTextOverride=="",if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentText"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentText")),AccentTextOverride)]
[h:AccentColor = if(AccentBackgroundOverride=="",if(number(getLibProperty("DarkMode","Lib:pm.a5e.Core")),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"DarkAccentBackground"),json.get(getLibProperty("ChatColors","Lib:pm.a5e.Core"),"LightAccentBackground")),AccentBackgroundOverride)]
