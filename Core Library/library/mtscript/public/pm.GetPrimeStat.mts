...
[h,if(json.type(pm.PrimeStatTemp) == "OBJECT"),CODE:{
	[h:pm.StatEval = ""]
	[h,foreach(tempStat,json.get(pm.PrimeStatTemp,"Stats")): pm.StatEval = listAppend(pm.StatEval,"json.get(Attributes,'"+tempStat+"')")]
	[h:pm.StatValue = eval(json.get(pm.PrimeStatTemp,"EvalMethod")+"("+pm.StatEval+")")]
	[h:pm.PrimeStatFinal = ""]
	[h,foreach(tempStat,json.get(pm.PrimeStatTemp,"Stats")): pm.PrimeStatFinal = if(json.get(Attributes,tempStat)==pm.StatValue,tempStat,pm.PrimeStatFinal)]
