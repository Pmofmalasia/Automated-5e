...
[h:pm.TargetCategory = json.get(arg(0),"Category")]
...
[h,switch(pm.TargetCategory),CODE:
   case "Creature":{
      [h,if(getProperty("TargetingStyle")=="Impersonate"),CODE:{
         [h:pm.a5e.ImpersonatedTargeting(pm.ValidTargets)]
      };{}]

      [h,if(getProperty("TargetingStyle")=="Input"),CODE:{
         [h:pm.a5e.InputTargeting(json.set("","ValidTargets",pm.ValidTargets,"SingleTarget",if(pm.TargetNum==1,1,0)))]
      };{}]
   };
   case "Item":{
