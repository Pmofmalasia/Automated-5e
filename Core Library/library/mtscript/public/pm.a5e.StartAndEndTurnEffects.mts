...
[h,foreach(condition,validConditions),CODE:{
	...
	[h:setProperty("a5e.stat.ConditionGroups",json.path.setcarefully(getProperty("a5e.stat.ConditionGroups"),"[*][?(@.GroupID=="+json.get(condition,"GroupID")+")]['Duration']",newDuration))]
...
[h,foreach(condition,validConditionsSet),CODE:{
	...
	[h:setProperty("a5e.stat.ConditionsSet",json.path.setcarefully(getProperty("a5e.stat.ConditionsSet"),"[*][?(@.GroupID=="+thisGroupID+")]['Duration']",newDuration))]
	[h,foreach(target,json.get(condition,"Targets")),CODE:{
		[h:switchToken(target)]
		[h:setProperty("a5e.stat.ConditionGroups",json.path.setcarefully(getProperty("a5e.stat.ConditionGroups"),"[*][?(@.GroupID=="+thisGroupID+")]['Duration']",newDuration))]
		[h:setProperty("a5e.stat.ConditionList",json.path.setcarefully(getProperty("a5e.stat.ConditionList"),"[*][?(@.GroupID=="+thisGroupID+")]['Duration']",newDuration))]
...
[h:pm.a5e.BaseEffectData = json.set("",
	...
	"DisplayName",StartorEnd+" of Turn Effect",
	"Type","Save",
