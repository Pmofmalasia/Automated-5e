...
[h:thisPlayerChatSettings = json.get(allPlayerChatSettings,getPlayerName())]
[h:thisPlayerChatColors = json.get(thisPlayerChatSettings,"ChatColors")]
...
[h:abort(input(
	...
	"choice.DisplayType | Fixed Width,Maximum Width,Unlimited Width | Tooltip Width Options | LIST | SELECT="+if(json.get(thisPlayerChatSettings,"UseWidth")=="",json.get(defaultChatSettings,"UseWidth"),json.get(thisPlayerChatSettings,"UseWidth"))+" ",
	...
	"choice.DarkAccent | "+if(json.get(thisPlayerChatColors,"DarkAccent")=="",json.get(defaultChatColors,"DarkAccent"),json.get(thisPlayerChatColors,"DarkAccent"))+" | Dark Mode Accent Color",
	...
	"choice.DarkLink | "+if(json.get(thisPlayerChatColors,"DarkLink")=="",json.get(defaultChatColors,"DarkLink"),json.get(thisPlayerChatColors,"DarkLink"))+" | Dark Mode Link Color",
    ...
    "choice.LightAccent | "+if(json.get(thisPlayerChatColors,"LightAccent")=="",json.get(defaultChatColors,"LightAccent"),json.get(thisPlayerChatColors,"LightAccent"))+" | Light Mode Accent Color",
	...
	"choice.LightLink | "+if(json.get(thisPlayerChatColors,"LightLink")=="",json.get(defaultChatColors,"LightLink"),json.get(thisPlayerChatColors,"LightLink"))+" | Light Mode Link Color",
...
[h,if(choice.Default),CODE:{
	[h:allPlayerChatSettings = json.remove(allPlayerChatSettings,getPlayerName())]
};{
	...
	[h:allPlayerChatSettings = json.set(allPlayerChatSettings,getPlayerName(),thisPlayerChatSettings)]
}]
