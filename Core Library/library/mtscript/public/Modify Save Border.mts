...
[h,if(effectID==""),CODE:{};{
	[h:rerolledEffect = json.path.setcarefully(getLibProperty("gd.Effects","Lib:pm.a5e.Core"),"[*][?(@.ID=="+effectID+")]['ToResolve']['SaveDC']['SavesMade']['"+ParentToken+"']",json.remove(SaveData,"EffectID"))]
