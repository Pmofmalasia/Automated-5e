...
[h:validConditions = json.path.read(getProperty("a5e.stat.ConditionGroups"),"[*][?(@.Duration.AdvancePoint=='StartofTurn')]")]
...
[h:targetsAffected = ""]
[h:validConditionsSet = json.path.read(getProperty("a5e.stat.ConditionsSet"),"[*][?(@.Duration.AdvancePoint=='StartofSetByTurn')]")]
